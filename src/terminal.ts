...
function theme(): ITheme {
  return {
    ...
    yellow: token('--amber'),
    blue: token('--blue'),
    magenta: token('--violet'),
    cyan: token('--cyan'),
    white: token('--gray-6'),
    brightBlack: token('--gray-5'),
    brightRed: token('--coral'),
    brightGreen: token('--sage'),
    brightYellow: token('--chalk'),
    brightBlue: token('--sky'),
    brightMagenta: token('--violet'),
    brightCyan: token('--cyan'),
    brightWhite: token('--gray-7'),
  };
}
